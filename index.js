...
new TypeIt("#type1", {
  ...
  .type("MERN Stack Developer", { delay: 500 })
  .pause(500)
  .delete(20)
  .type("Freelancer", { delay: 400 })
  .pause(500)
  .delete(10)
  .go();
...
gsap.from(".hero p", { opacity: 0, duration: 1, delay: 3.5, y: -15 });
gsap.from(".hero a", { opacity: 0, duration: 1, delay: 4, y: 50 });
gsap.from(".nav-item", {
  opacity: 0,
  duration: 1,
  delay: 1.2,
